...
$startupProjectFile = Join-Path -Path "$rootDir" -ChildPath $config.webAppProjectFile
$projectFile = Join-Path -Path "$rootDir" -ChildPath $config.databaseMigrations.projectFile
